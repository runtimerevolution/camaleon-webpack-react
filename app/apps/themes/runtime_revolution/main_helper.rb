module Themes::RuntimeRevolution::MainHelper
  def self.included(klass)
    # klass.helper_method [:my_helper_method] rescue "" # here your methods accessible from views
  end

  def runtime_revolution_settings(theme)
    # callback to save custom values of fields added in my_theme/views/admin/settings.html.erb
  end

  # callback called after theme installed
  def runtime_revolution_on_install_theme(theme)
    # # Sample Custom Field
  ...
  def runtime_revolution_on_uninstall_theme(theme)
  end
end
